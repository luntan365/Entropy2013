...
#include "AutonomousCommand4.h"
#include "autonomous.h"

AutonomousCommand4::AutonomousCommand4() {
...
void AutonomousCommand4::Initialize() {
...
void AutonomousCommand4::Execute() {
	
}

// Make this return true when this Command no longer needs to run execute()
bool AutonomousCommand4::IsFinished() {
	//return EntropyAnonymousFinished();
	return true;
}

// Called once after isFinished returns true
void AutonomousCommand4::End() {
	
}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void AutonomousCommand4::Interrupted() {
